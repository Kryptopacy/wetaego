...
// Inject loyalty_settings and customer_profiles into public.Tables
const newTables = `
      customer_profiles: {
        Row: {
          id: string
...
// Find where Tables: { begins and inject right after it
if (!typesContent.includes('customer_profiles')) {
  ...
  console.log('Successfully injected CRM tables into types.ts')
} else {
  console.log('CRM tables already present in types.ts')
}
