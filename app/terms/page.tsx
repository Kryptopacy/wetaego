...
export const metadata: Metadata = {
  title: 'Terms of Service | WETAEGO',
  description: 'Terms and conditions for using WETAEGO',
  alternates: {
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-12 text-lg font-light leading-relaxed">
          <section>
            ...
            <p className="mb-4">
              WETAEGO (&quot;we&quot;, &quot;us&quot;, &quot;our&quot;) provides a hospitality and commercial management software platform (the &quot;Service&quot;) to businesses, venues, and enterprises (the &quot;Merchant&quot;). We are strictly a software provider. We do not prepare, handle, or deliver products, nor do we manage the day-to-day operations of the Merchant&apos;s business.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-zinc-400">
              <li>The quality, safety, and accurate representation of all items and services sold.</li>
            ...
            <p className="mt-4">
              WETAEGO assumes no liability for food poisoning, allergic reactions, unfulfilled orders, or any other issues arising directly from the Merchant&apos;s physical services or products.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-4">
              WETAEGO facilitates payments via third-party processors (e.g., Paystack). We utilize <strong>Subaccounts</strong> to route transactions directly to the Merchant. By enabling live payments, the Merchant agrees to the following fee structure and compliance requirements:
            </p>
            <ul className="list-disc pl-6 space-y-2 text-zinc-400 mb-4">
              <li><strong>Platform Fee:</strong> WETAEGO charges a standard platform fee (e.g., 5%) per successful transaction processed through the Service, deducted automatically prior to payout.</li>
            ...
            <p>
              Because the Merchant is the Merchant of Record, <strong>all requests for refunds, including instances of customer overpayment or order cancellation, must be directed to and handled by the Merchant.</strong> WETAEGO does not hold customer funds and cannot issue refunds on behalf of a Merchant.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-4">
              Merchants agree not to use the Service for any unlawful purpose, including but not limited to the sale of illegal substances, money laundering, or fraudulent activities. WETAEGO reserves the right to suspend or terminate access to the Service immediately upon suspicion of violation of these terms.
            </p>
          </section>
