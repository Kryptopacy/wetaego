  ...
  return (
    <div className="max-w-2xl mx-auto min-h-screen p-6 animate-pulse">
      ...
      <div className="space-y-6">
        {[1, 2, 3].map(i => (
          <div key={i} className="flex flex-col sm:flex-row gap-4 p-4 rounded-2xl bg-zinc-900/50 border border-zinc-800">
            {/* Desktop Image (Right) -> Mobile Image (Top) */}
            <div className="w-full sm:w-24 h-48 sm:h-24 bg-zinc-800 rounded-xl shrink-0 order-1 sm:order-2"></div>
