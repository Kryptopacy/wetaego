  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white font-sans" style={{ backgroundColor: (page as { background_color?: string }).background_color || undefined }}>
      ...
      <StorefrontHero
        ...
        badge={{ text: '📅 Reservations & Appointments' }}
        coverImageUrl={location.cover_image_url}
        businessTypePreset={page.business_type_preset || 'spa_wellness'}
          ...
          <div className="space-y-8">
            ...
            {filteredItems.length === 0 && (
              <EmptyState
                ...
                description={searchQuery ? `No services found matching "${searchQuery}". Try a different term.` : "Available booking slots and services will be listed here shortly."}
                className="my-8"
              />
            )}
          </div>
