...
export function InfoStrip({ location }: InfoStripProps) {
  ...
  return (
    <div className="flex flex-wrap gap-2 mt-4">
      {hours && (
        <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-zinc-800/80 backdrop-blur-md border border-zinc-700/50 text-xs font-medium text-zinc-200">
      ...
      {ig && (
        <a 
          ...
          className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-zinc-800/80 hover:bg-zinc-700 transition-colors backdrop-blur-md border border-zinc-700/50 text-xs font-medium text-zinc-200"
        >
