              ...
              <div className="p-6">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4 pt-4 border-t border-zinc-200 dark:border-zinc-800">
                    <div className="p-2.5 rounded-full bg-zinc-100 dark:bg-zinc-800 text-zinc-600 dark:text-zinc-400">
                      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5h12M9 3v2m1.048 9.5A18.022 18.022 0 016.412 9m6.088 9h7M11 21l5-10 5 10M12.751 5C11.783 10.77 8.07 15.61 3 18.129" />
                      </svg>
                    </div>
                    <div className="flex-1">
                      <h4 className="text-sm font-semibold text-[#17201b] dark:text-zinc-300">Language</h4>
                      <select 
                        className="mt-2 block w-full rounded-xl border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 px-3 py-2 text-sm text-zinc-900 dark:text-white shadow-sm focus:border-theme focus:ring-theme"
                        onChange={(e) => {
