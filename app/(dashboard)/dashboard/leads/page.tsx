  ...
  return (
    <div className="max-w-5xl space-y-6 pb-24">
      <PageHeader
        ...
        description="Track and manage all customer inquiries and bookings from your property and service listings."
        action={
          newCount > 0 ? (
            <span className="px-3 py-1.5 rounded-full bg-emerald-500/10 text-emerald-400 text-xs font-bold border border-emerald-500/20">
              {newCount} New
            </span>
          ) : undefined
        }
