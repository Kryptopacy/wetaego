...
import { Bot, Sparkles, Shield, HelpCircle, BookOpen } from 'lucide-react'
  ...
  return (
    <div className="max-w-6xl space-y-8 pb-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        {/* Left Column: Persona, Instructions, & Knowledge Base */}
          ...
          <ActionForm action={saveLocationAiSettings} className="space-y-8">
            ...
            <div className="rounded-2xl border border-zinc-800 bg-zinc-900/50 p-6 space-y-6">
              <div className="flex items-center justify-between pb-6 border-b border-zinc-800">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-zinc-400 mt-0.5">
                      Set your bot's public name and conversational cadence.
                    </p>
                  </div>
                </div>
                ...
                <div className="w-36">
                  <select
                    ...
                    className="w-full rounded-xl border border-zinc-700 bg-zinc-800 px-3 py-2 text-sm text-white outline-none focus:border-blue-500 font-semibold"
                  >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="upscale">🍷 Upscale & Sommelier</option>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-zinc-700 bg-zinc-800/60 px-4 py-2.5 text-white outline-none focus:border-blue-500 text-sm"
                  placeholder="e.g. Call host desk at 555-0199 or speak to any staff member"
                  maxLength={200}
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full rounded-xl border border-zinc-700 bg-zinc-800/60 px-4 py-2.5 text-white outline-none focus:border-blue-500 text-sm"
                  placeholder="e.g. Always pair red meat with our signature cabernet. Mention that our steak is 24-hour marinated."
                  maxLength={2000}
                />
              </div>
            </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-amber-200/80 mt-1 leading-relaxed">
                      During peak rush hours, the AI proactively resolves guest queries and queues non-critical feedback for post-rush review instead of interrupting floor managers.
                    </p>
                  </div>
                </div>
                <input
            ...
            <div className="rounded-2xl border border-zinc-800 bg-zinc-900/50 p-6 space-y-6">
              <div className="flex items-center gap-3 pb-6 border-b border-zinc-800">
                ...
                <div>
                  <h2 className="text-lg font-bold text-white">Brand Knowledge & Policies</h2>
                  <p className="text-xs text-zinc-400 mt-0.5">
                    Provide venue backstory, dress code, parking instructions, and dietary guidelines.
                  </p>
                </div>
              </div>
