...
export default async function CustomersPage() {
  ...
  return (
    <div className="max-w-6xl space-y-6 pb-20">
      <PageHeader
        title="CRM & Loyalty"
        description="Manage customer profiles, loyalty tiers, and contact histories collected across checkouts."
        action={
          <Link 
            href="/dashboard/settings?tab=general" 
            className="px-3.5 py-2 bg-zinc-800 hover:bg-zinc-700 text-zinc-200 hover:text-white font-semibold rounded-xl border border-zinc-700 transition-colors flex items-center gap-2 text-xs"
          >
