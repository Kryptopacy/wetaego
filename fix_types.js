...
// Find the exact "credit_transactions: {" block inside the "public" schema's "Tables"
const regex = /public: \{\s*Tables: \{[\s\S]*?(        credit_transactions: \{)/;
content = content.replace(regex, (match, p1) => {
  return match.replace(p1, typesToInsert + p1)
})
