...
export function OrdersClient({ organizationId, initialOrders, initialServiceRequests }: OrdersClientProps) {
  ...
  return (
    <div className="flex-1 grid grid-cols-1 lg:grid-cols-3 gap-6 overflow-hidden mt-8">
