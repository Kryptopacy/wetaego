...
export const BUSINESS_TYPE_PRESETS: Record<string, BusinessTypePreset> = {
  ...
  other_food: {
    ...
    description: 'Flexible catalog for bakeries, delis, and more',
    icon: '🍽️',
    template_type: 'catalog',
    billing_enabled: true,
    billing_mode: 'standard_checkout',
    ...
    deposit_percentage: 0,
    default_page_title: "{businessName}",
    ai_cover_hint: 'appetizing food photography, warm and inviting atmosphere',
    ai_item_hint: 'a delicious food or drink description',
    group: 'food_drink',
  },
  ...
  other_hospitality: {
    ...
    description: 'Flexible booking for tours, activities, and rentals',
    icon: '🏨',
    template_type: 'booking',
    billing_enabled: true,
    billing_mode: 'standard_checkout',
    payment_mode: 'deposit',
    deposit_percentage: 30,
    default_page_title: "Book with {businessName}",
    ai_cover_hint: 'welcoming hospitality environment, clean and professional',
    ai_item_hint: 'a booking or rental description, clear and inviting',
    group: 'hospitality',
  },
  ...
  agency: {
    label: 'Agency (Marketing / PR)',
    description: 'B2B service tiers and quote generation',
    icon: '🏢',
    template_type: 'quote',
    billing_enabled: false,
    billing_mode: 'standard_checkout',
    payment_mode: 'full',
    deposit_percentage: 0,
    default_page_title: "{businessName} — Rate Card & Services",
    ai_cover_hint: 'modern agency office, people working on laptops, bright and collaborative',
    ai_item_hint: 'an agency service description (e.g. SEO package, PR campaign), corporate and persuasive',
    group: 'creative',
  },
  freelancer: {
    ...
    ai_cover_hint: 'modern workspace, laptop, creative tools, professional and clean aesthetic',
    ai_item_hint: 'a freelance service description, clear and value-driven',
    group: 'creative',
  },
  other_creative: {
    label: 'Other Creative / Agency',
    description: 'Flexible rate card for consultants, designers, and agencies',
    icon: '💡',
    template_type: 'rate_card',
    billing_enabled: false,
    billing_mode: 'standard_checkout',
    ...
    ai_cover_hint: 'creative studio or agency office, inspiring and modern',
    ai_item_hint: 'a professional service description',
    group: 'creative',
  },
  coach_tutor: {
  ...
  other_services: {
    ...
    description: 'Flexible quotes for cleaning, plumbing, or consulting',
    icon: '💼',
    template_type: 'quote',
    billing_enabled: false,
    billing_mode: 'standard_checkout',
    ...
    deposit_percentage: 30,
    default_page_title: "{businessName} — Services",
    ai_cover_hint: 'professional service provider at work, trustworthy and reliable',
    ai_item_hint: 'a service or consultation description',
    group: 'services',
  },
